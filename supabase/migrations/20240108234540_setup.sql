...
AS $$
DECLARE
  project_url TEXT := 'https://rmmbfvoyufpdprqbzaox.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJtbWJmdm95dWZwZHBycWJ6YW94Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MDEyNDk1NSwiZXhwIjoyMDU1NzAwOTU1fQ.MBdy-Ch3SXSUp3iyVWCWhTkpJWHyvTEuAOchKn7G_XU'; -- full access needed for http request to storage
